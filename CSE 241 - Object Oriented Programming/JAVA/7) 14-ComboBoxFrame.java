...
public class ComboBoxFrame extends JFrame
{
	...
	public ComboBoxFrame()
	{
		...
		imagesJComboBox.addItemListener(
			...
			//inner class doesn't have a name bc I am not gonna use the objects of inner
			//	class in many places.
			//I am gonna use object of inner class in 1 place. 
			//That's why I don't wanna give name to inner class.
			//This anonymous class implements ItemListener interface
			{
			...
			// --> /**/ ... /**/ <-- between these two is anonymous inner class
