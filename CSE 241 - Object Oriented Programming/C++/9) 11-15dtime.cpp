...
namespace
{
	//we put the functions that do not obey the encapsulation rule in class (bc they are not working on my data) to unnamed namespace
    //this makes them local to this compilation unit only
    //because nobody can accesss to digitToInt, readMinute, readHour functions
    //except dtime.cpp compilation unit
