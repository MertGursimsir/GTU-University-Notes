...
//I don't have anything about define DTIME_H thing
#include <iostream>
#include <cctype>
#include <cstdlib>
using namespace std;
...
Since the first time it include dtime.h, it will define DTIME_H
Second time it included, it will not redefine it because it is already defined
It will skip to endif part
*/
